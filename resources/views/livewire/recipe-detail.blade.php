<div>
    ...
    {{-- JSON-LD structured data (built in RecipeDetail::jsonLd(), CQ.10) --}}
    <script type="application/ld+json">{!! json_encode($this->jsonLd, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_HEX_TAG | JSON_HEX_AMP) !!}</script>
</div>
