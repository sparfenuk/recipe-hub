<x-layouts.guest :title="__('Forgot password?')">
    ...
    <h1 class="mb-2 text-center text-2xl font-bold text-slate-900">{{ __('Forgot your password?') }}</h1>
    ...
    <p class="mt-6 text-center text-sm text-slate-600">
        <a href="{{ route('login') }}" class="font-medium text-emerald-600 hover:text-emerald-500">{{ __('Back to log in') }}</a>
    </p>
</x-layouts.guest>
